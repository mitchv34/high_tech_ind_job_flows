...
==========================================================================================#
function split_skill_dist(prim::Primitives; unemployment_rate::Float64 = 0.1, weights::Array{Float64, 1} = [0.0], verbose::Bool = false)
    ...
    e = (1 - unemployment_rate) .* ℓ # Distribution of employed workers
