...
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, interior hidden, enhanced, sharp corners, borderline west={3pt}{0pt}{shadecolor}, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\item[$\square$]
  Read (\protect\hyperlink{ref-baggerEmpiricalModelWage2019}{Bagger and
  Lentz 2019})
\item[$\square$]
...
\leavevmode\vadjust pre{\hypertarget{ref-baggerEmpiricalModelWage2019}{}}%
