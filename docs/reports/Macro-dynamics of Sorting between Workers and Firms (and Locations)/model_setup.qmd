...
- Continuum of workers indexed by their ability $x\in \mathcal{X}$ with $\mathcal{X}$ compact.
...
- Continuum of firms indexed by technology $y\in \mathcal{Y}$ with $\mathcal{Y}$ compact.
